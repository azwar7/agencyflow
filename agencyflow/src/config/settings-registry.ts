...
export const SETTINGS_NAVIGATION_GROUPS: SettingsCategoryGroup[] = [
  ...
  },
  {
    ...
    tabs: [
      ...
      { id: 'api-webhooks', label: 'API Keys & Webhooks', icon: 'key', description: 'Hashed REST API keys, outbound webhook subscribers, and test pinger', isImplemented: true, roleRequired: 'ADMIN' },
    ],
  },
  {
    id: 'system-data',
    label: 'SYSTEM & DATA',
    tabs: [
      { id: 'data-export', label: 'Data Management', icon: 'download', description: 'CSV import engine, role-based export, and dataset tooling', isImplemented: true, roleRequired: 'ADMIN' },
      { id: 'sandbox-seed', label: 'Sandbox & Demo Data', icon: 'database', description: 'Testing mode toggle and guaranteed safe demo record cleanup', isImplemented: true, roleRequired: 'ADMIN' },
  ...
  },
  {
    ...
    label: 'ACCOUNT',
    tabs: [
      { id: 'subscription-billing', label: 'Subscription & Usage', icon: 'credit-card', description: 'Real team seats, CRM record breakdown, and resource usage', isImplemented: true, roleRequired: 'OWNER' },
      { id: 'danger-zone', label: 'Danger Zone', icon: 'alert-triangle', description: 'Irreversible CRM data purge and workspace dissolution', isImplemented: true, roleRequired: 'OWNER' },
    ],
  },
];
...
export const SETTINGS_REGISTRY: SettingRegistryEntry[] = [
  ...
  {
    id: 'auto-api-keys',
    title: 'REST API Keys & Webhooks',
    category: 'Automation & AI',
    tabId: 'api-webhooks',
    sectionId: 'api-keys',
    description: 'Hashed developer API keys, outbound webhook subscribers, and signature verification.',
    keywords: ['api key', 'rest', 'developer', 'webhooks', 'hmac', 'tokens', 'endpoints'],
    roleRequired: 'ADMIN',
    isImplemented: true,
  },
  {
    id: 'sys-data-management',
    title: 'Data Import, Export & Backups',
    category: 'System & Data',
    tabId: 'data-export',
    sectionId: 'data-management',
    description: 'CSV bulk import, role-based data export (CSV/JSON), and data cleanup tools.',
    keywords: ['import', 'export', 'csv', 'backup', 'json', 'download', 'contacts', 'leads'],
    roleRequired: 'ADMIN',
    isImplemented: true,
  },
  {
    id: 'acc-billing-usage',
    title: 'Subscription Tier & Resource Usage',
    category: 'Account',
    tabId: 'subscription-billing',
    sectionId: 'billing-usage',
    description: 'Team seats, CRM record breakdown, AI executions, and storage metrics.',
    keywords: ['billing', 'usage', 'subscription', 'plan', 'seats', 'storage', 'credits'],
    roleRequired: 'OWNER',
    isImplemented: true,
  },
  {
    id: 'acc-danger-zone',
    title: 'Danger Zone & Workspace Dissolution',
    category: 'Account',
    tabId: 'danger-zone',
    sectionId: 'danger-zone',
    description: 'Permanent CRM data purging and workspace deletion with security verification.',
    keywords: ['delete workspace', 'purge data', 'danger zone', 'dissolve', 'reset'],
    roleRequired: 'OWNER',
    isImplemented: true,
  },
];
